...
!Copyright>        commercial version may interest you: https://www.altair.com/radioss/.
      module multimat_method_mod
         ...
         type multimat_method_struct
           integer is_defined_1  !0.or.1  "mmale=1: Staggered Upwind advection + von Neumann-Richtmyer artificial viscosity + diffuse interface method"
           integer is_defined_2  !0.or.1  "mmale=2: Collocated HLLC + diffuse interface method"
           integer is_defined_3  !0.or.1  "mmale=3: Collocated HLLC + lagrangian interface tracking"
      ...
      contains
        ...
        subroutine multimat_method_write_to_restart(this)
          ...
          ALLOCATE (IBUF(NFIX))
          IAD = 1
          IBUF(IAD) = this%is_defined_1
          IAD = IAD+1
          IBUF(IAD) = this%is_defined_2
          IAD = IAD+1
          IBUF(IAD) = this%is_defined_3
          IAD = IAD+1
          IBUF(IAD) = this%nb
          IAD = IAD+1
          do i=1,this%nb
        ...
        subroutine multimat_method_read_from_restart(this)
          ...
          this%is_defined_1 = ILEN4(1)
          this%is_defined_2 = ILEN4(2)
          this%is_defined_3 = ILEN4(3)
          this%nb = ILEN4(4)
