...
! ======================================================================================================================
          ...
          use constant_mod , only : two_third, three100
...
!=======================================================================
              ...
              IF (V1  >  ZERO) THEN
                ...
                DVOL = V1-V1I
                DF1 = RHO10/RHO1
                CALL POLYNOMIAL51 (C01,C11,C21,C31,C41,C51, &
                  V1,DVOL,MU1,EINT1, &
                  PEXT,P1,PM1, &
                  DPDE1, DPDMU1, DF1)
                  SSP1 = SQRT((DPDMU1 + TWO_THIRD*GG1(I))/RHO10)
              ...
              IF (V2  >  ZERO) THEN
                ...
                DVOL = V2-V2I
                DF2 = RHO20/RHO2
                CALL POLYNOMIAL51 (C02,C12,C22,C32,C42,C52, &
                  V2,DVOL,MU2,EINT2, &
                  PEXT,P2,PM2, &
                  DPDE2, DPDMU2, DF2)
                  SSP2 = SQRT((DPDMU2 + TWO_THIRD*GG2(I))/RHO20)
              ...
              IF (V3  >  ZERO) THEN
                ...
                DVOL = V3-V3I
                DF3 = RHO30/RHO3
                CALL POLYNOMIAL51 (C03,C13,C23,C33,C43,C53, &
                  V3,DVOL,MU3,EINT3, &
                  PEXT,P3,PM3, &
                  DPDE3, DPDMU3, DF3)
                  SSP3 = SQRT((DPDMU3 + TWO_THIRD*GG3(I))/RHO30)
