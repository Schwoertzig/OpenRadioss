...
! ----------------------------------------------------------------------------------------------------------------------
      ...
      use constant_mod , only : zero, em06, one, third, fourth, half, two
...
! ----------------------------------------------------------------------------------------------------------------------
      ...
      integer isolnod
      my_real orient,rho,c,fc,roc,alp,vol,volg,mass,mass_face,mass_face_old
      my_real x13,y13,z13,x24,y24,z24,nx,ny,z,s
      my_real roou,enou,vmx,vmy,vmz,fluxi,fluxo,p,dvx,dvy,dvz
      my_real v0(3,nod)
      my_real xsn,ysn,zsn
      my_real xn, yn, zn, vold, vnew, pold, padj, eadj, tadj
      my_real dp0,mach,pp,ee,tt, ssp,rhoc2,vel_front,fac1,fac2
